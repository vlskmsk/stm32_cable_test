...
void MX_GPIO_Init(void)
{
	...
	HAL_GPIO_WritePin(GPIOB, GPIO_PIN_12|GPIO_PIN_14|GPIO_PIN_9, GPIO_PIN_RESET);

	/*Configure GPIO pins : PB12 PB14 PB9 */
	GPIO_InitStruct.Pin = GPIO_PIN_12|GPIO_PIN_14|GPIO_PIN_9;
